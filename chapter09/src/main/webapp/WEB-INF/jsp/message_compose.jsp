...
<s:layout-component name="body">
	...
	<s:form beanclass="stripesbook.action.MessageComposeActionBean" enctype="multipart/form-data">
		...
		<th align="left">
			...
			<tr>
				<th>Subject:</th>
				<td><s:text name="message.subject" size="87"/></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td colspan="3"><s:textarea name="message.text" cols="96" rows="12"/></td>
			</tr>
			</table>
		</th>
		<th valign="top">
			<s:select name="contacts" multiple="true" size="7">
				<s:options-collection collection="${actionBean.allContacts}" value="id" sort="firstName" />
			</s:select>
		</th>
		</tr>
		</table>
